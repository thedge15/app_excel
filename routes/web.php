...
Route::middleware('auth')->group(function () {
    Route::prefix('/projects')->group(function () {
        ...
        Route::get('/import', [\App\Http\Controllers\ProjectController::class, 'import'])->name('project.import');
        Route::post('/import', [\App\Http\Controllers\ProjectController::class, 'importStore'])->name('project.import.store');
    });
